...
class DataGenerator:
    ...
    def shuffle_data(self):
        ...
        # Создим список перестановочного индекса и перемешаем данные в соответствии с списком
    ...
    # Эта функция получает следующие n (= batch_size) изображений из списка путей, маркирует и загружает изображения
    # в память
    def next(self):
        ...
        # Разворачиваем метки до одной кодировки
        # Возвращаем новый массив заданной формы и типа, заполненный нулями.nt
